...
class SupplierController extends library\Controller
{
    /**
    ...
    public function actionData(){
        ...
        foreach ($dataProvider->getData() as $key => $value) {
            $row = array();
                        ...
                        $row['barangay']= $value->barangay;
                        $row['municipal']= $value->municipal;
                        ...
                        $row['update_date']= $value->update_date;
                        $row['update_by']= $value->update_by;
                        
                        
            $row['links']= '<a class="view" title="View" data-toggle="tooltip" href="'.$this->createUrl('/a6156841/supplier/view',array('id'=>$value->supplier_id)).'" data-original-title="View"><i class="fa fa-eye"></i></a>'
                        . '&nbsp;<a class="update" title="Update" data-toggle="tooltip" href="'.$this->createUrl('/a6156841/supplier/update',array('id'=>$value->supplier_id)).'" data-original-title="View"><i class="fa fa-pencil"></i></a>'
                        . '&nbsp;<a class="delete" title="Delete" data-toggle="tooltip" href="'.$this->createUrl('/a6156841/supplier/delete',array('id'=>$value->supplier_id)).'" data-original-title="Delete"><i class="fa fa-trash-o"></i></a>';
    ...
    */
    public function actionView($id)
    {
        ...
        $this->pageTitle = 'View Supplier '.$model->supplier_id;
    ...
    */
    public function actionUpdate($id)
    {
        ...
        $this->pageTitle = 'Update Supplier '.$model->supplier_id;
