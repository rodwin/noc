...
$(function() {
    var table = $('#authitem_table').dataTable({
        ...
        "columns": [
            { "name": "name","data": "name"},{ "name": "type","data": "type"},{ "name": "description","data": "description"},{ "name": "bizrule","data": "bizrule"},{ "name": "data","data": "data"},            { "name": "links","data": "links", 'sortable': false}
               ]
        });
