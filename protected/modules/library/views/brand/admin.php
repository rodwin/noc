...
$(function() {
    var table = $('#brand_table').dataTable({
        ...
        "columns": [
            { "name": "brand_id","data": "brand_id"},{ "name": "brand_category_id","data": "brand_category_id"},{ "name": "brand_code","data": "brand_code"},{ "name": "brand_name","data": "brand_name"},{ "name": "created_date","data": "created_date"},{ "name": "created_by","data": "created_by"},{ "name": "updated_date","data": "updated_date"},            { "name": "links","data": "links", 'sortable': false}
               ]
        });

        $('#btnSearch').click(function(){
            table.fnMultiFilter( { 
                "brand_id": $("#Brand_brand_id").val(),"brand_category_id": $("#Brand_brand_category_id").val(),"brand_code": $("#Brand_brand_code").val(),"brand_name": $("#Brand_brand_name").val(),"created_date": $("#Brand_created_date").val(),"created_by": $("#Brand_created_by").val(),"updated_date": $("#Brand_updated_date").val(),            } );
        });
