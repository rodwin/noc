...
$(function() {
    var table = $('#salesman_table').dataTable({
        ...
        "columns": [
            { "name": "salesman_id","data": "salesman_id"},{ "name": "team_leader_id","data": "team_leader_id"},{ "name": "salesman_name","data": "salesman_name"},{ "name": "salesman_code","data": "salesman_code"},{ "name": "mobile_number","data": "mobile_number"},{ "name": "device_no","data": "device_no"},{ "name": "other_fields_1","data": "other_fields_1"},            { "name": "links","data": "links", 'sortable': false}
               ]
        });

        $('#btnSearch').click(function(){
            table.fnMultiFilter( { 
                "salesman_id": $("#Salesman_salesman_id").val(),"team_leader_id": $("#Salesman_team_leader_id").val(),"salesman_name": $("#Salesman_salesman_name").val(),"salesman_code": $("#Salesman_salesman_code").val(),"mobile_number": $("#Salesman_mobile_number").val(),"device_no": $("#Salesman_device_no").val(),"other_fields_1": $("#Salesman_other_fields_1").val(),            } );
        });
