...
<div>
    ...
    <div style="float: left; margin-right: 20px;">
        ...
        <?php echo CHtml::textField('minimum_value', $unserialize_attribute['min_value'], array('class' => 'span5', 'maxlength' => 50, 'style' => 'width: 100px;')); ?> 
    </div>

    <div style="float: left;">
        <?php echo $form->label($model, 'Maximum Value <i style="color: red;">*</i>', array('class' => 'control-label')); ?><br/>
        <?php echo CHtml::textField('maximum_value', $unserialize_attribute['max_value'], array('class' => 'span5', 'maxlength' => 50, 'style' => 'width: 100px;')); ?> 
    </div>
