<div class="view">
    ...
    <?php echo CHtml::link(CHtml::encode($data->sales_office_id), array('view', 'id' => $data->sales_office_id)); ?>
    <br />
    ...
    <b><?php echo CHtml::encode($data->getAttributeLabel('sales_office_code')); ?>:</b>
    <?php echo CHtml::encode($data->sales_office_code); ?>
    <br />

    <b><?php echo CHtml::encode($data->getAttributeLabel('sales_office_name')); ?>:</b>
    <?php echo CHtml::encode($data->sales_office_name); ?>
    <br />
