...
<div class="form-group">
    ...
    <div class="input-group">
        ...
        <input id="add_dropdown_value" type="text" class="form-control" placeholder="" maxlength="<?php echo PoiCustomData::CUSTOM_VALUE_LENGTH; ?>"/>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <?php echo $form->error($poi_custom_data, "dropDownList_multiple", array("style" => "color: #f56954;")); ?>
        </div>
    </div>
