...
$(function() {
    var table = $('#poi-category_table').dataTable({
        ...
        "columns": [
            { "name": "poi_category_id","data": "poi_category_id"},{ "name": "category_name","data": "category_name"},{ "name": "created_date","data": "created_date"},{ "name": "created_by","data": "created_by"},{ "name": "updated_date","data": "updated_date"},{ "name": "updated_by","data": "updated_by"},            { "name": "links","data": "links", 'sortable': false}
               ]
        });

        $('#btnSearch').click(function(){
            table.fnMultiFilter( { 
                "poi_category_id": $("#PoiCategory_poi_category_id").val(),"category_name": $("#PoiCategory_category_name").val(),"created_date": $("#PoiCategory_created_date").val(),"created_by": $("#PoiCategory_created_by").val(),"updated_date": $("#PoiCategory_updated_date").val(),"updated_by": $("#PoiCategory_updated_by").val(),            } );
        });
