...
$(function() {
    var table = $('#sku-status_table').dataTable({
        ...
        "columns": [
            { "name": "sku_status_id","data": "sku_status_id"},{ "name": "status_name","data": "status_name"},{ "name": "created_date","data": "created_date"},{ "name": "created_by","data": "created_by"},{ "name": "updated_date","data": "updated_date"},{ "name": "updated_by","data": "updated_by"},            { "name": "links","data": "links", 'sortable': false}
               ]
        });

        $('#btnSearch').click(function(){
            table.fnMultiFilter( { 
                "sku_status_id": $("#SkuStatus_sku_status_id").val(),"status_name": $("#SkuStatus_status_name").val(),"created_date": $("#SkuStatus_created_date").val(),"created_by": $("#SkuStatus_created_by").val(),"updated_date": $("#SkuStatus_updated_date").val(),"updated_by": $("#SkuStatus_updated_by").val(),            } );
        });
