...
$(function() {
    var table = $('#uom_table').dataTable({
        ...
        "columns": [
            { "name": "uom_id","data": "uom_id"},{ "name": "uom_name","data": "uom_name"},{ "name": "created_date","data": "created_date"},{ "name": "created_by","data": "created_by"},{ "name": "updated_date","data": "updated_date"},{ "name": "updated_by","data": "updated_by"},            { "name": "links","data": "links", 'sortable': false}
               ]
        });

        $('#btnSearch').click(function(){
            table.fnMultiFilter( { 
                "uom_id": $("#Uom_uom_id").val(),"uom_name": $("#Uom_uom_name").val(),"created_date": $("#Uom_created_date").val(),"created_by": $("#Uom_created_by").val(),"updated_date": $("#Uom_updated_date").val(),"updated_by": $("#Uom_updated_by").val(),            } );
        });
