...
<script type="text/javascript">
   $(function() {
      var table = $('#brand-category_table').dataTable({
         ...
         "columns": [
            //                { "name": "brand_category_id","data": "brand_category_id"},
            {"name": "category_name", "data": "category_name"}, {"name": "created_date", "data": "created_date"}, {"name": "created_by", "data": "created_by"}, {"name": "updated_by", "data": "updated_by"}, {"name": "updated_date", "data": "updated_date"}, {"name": "links", "data": "links", 'sortable': false}
         ]
      });

      $('#btnSearch').click(function() {
         table.fnMultiFilter({
            //                "brand_category_id": $("#BrandCategory_brand_category_id").val(),
            "category_name": $("#BrandCategory_category_name").val(), "created_date": $("#BrandCategory_created_date").val(), "created_by": $("#BrandCategory_created_by").val(), "updated_by": $("#BrandCategory_updated_by").val(), "updated_date": $("#BrandCategory_updated_date").val(), });
      });
