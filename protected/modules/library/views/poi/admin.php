...
//                { "name": "poi_id","data": "poi_id"},
                {"name": "short_name", "data": "short_name"}, {"name": "long_name", "data": "long_name"}, {"name": "primary_code", "data": "primary_code"}, {"name": "secondary_code", "data": "secondary_code"}, {"name": "barangay_id", "data": "barangay_id"}, {"name": "municipal_id", "data": "municipal_id"}, {"name": "poi_category_name", "data": "poi_category_name"}, {"name": "poi_sub_category_name", "data": "poi_sub_category_name"}, {"name": "links", "data": "links", 'sortable': false}
            ]
        });
...
//                "poi_id": $("#Poi_poi_id").val(),
                "short_name": $("#Poi_short_name").val(), "long_name": $("#Poi_long_name").val(), "primary_code": $("#Poi_primary_code").val(), "secondary_code": $("#Poi_secondary_code").val(), "barangay_id": $("#Poi_barangay_id").val(), "municipal_id": $("#Poi_municipal_id").val(), "poi_category_name": $("#Poi_poi_category_name").val(), "poi_sub_category_name": $("#Poi_poi_sub_category_name").val(), });
        });
