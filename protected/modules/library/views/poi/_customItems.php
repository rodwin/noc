            ...
            foreach ($custom_datas as $key => $val) {
                ...
                <?php } else if ($data_type == PoiCustomData::TYPE_NUMBER_ONLY) { ?>
                    ...
                    <div class="form-group">                        
                        ...
                        <?php echo CHtml::textField($post_name, isset($_POST[$post_name]) ? $_POST[$post_name] : $attr['default_value'], array('maxlength' => PoiCustomData::CUSTOM_VALUE_LENGTH, "onkeypress" => "return onlyDotsAndNumbers(this, event, $decimal_place)", 'class' => 'form-control input', 'placeholder' => $placeholder)) ?>
                        <?php echo isset($_POST[$post_name]) ? $form->error($poi_custom_data, $post_name, array("style" => "color: #f56954;")) : ""; ?>
                    </div>
