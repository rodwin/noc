            ...
            foreach ($custom_datas as $key => $val) {
                ...
                if ($data_type == 'Text and Numbers') {
                    ...
                    <?php } else { ?>     
                        ...
                        <div class="form-group">
                            <label><?php echo $label_name; ?></label>
                            <?php echo CHtml::textField($post_name, isset($_POST[$post_name]) ? $_POST[$post_name] : $attr['default_value'], array('maxlength' => isset($attr['max_character_length']) ? $attr['max_character_length'] : "", 'class' => 'form-control input-sm', 'placeholder' => $placeholder)); ?>
                            <?php echo $form->error($poi_custom_data, $post_name); ?>
                        </div>
