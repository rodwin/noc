                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            <?php
                            echo CHtml::dropDownList('Poi_poi_category_name', '', $poi_category, array(
                                'prompt' => 'Select Category',
                                'class' => 'form-control',
                                'ajax' => array(
                                    'type' => 'POST',
                                    'url' => CController::createUrl('poi/getAllSubCategoryByCategoryName'),
                                    'update' => '#Poi_poi_sub_category_name',
                                    'data' => array('poi_category_name' => 'js:this.value',),
                            )));
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            <?php echo CHtml::dropDownList('Poi_poi_sub_category_name', '', array(), array('prompt' => 'Select Sub Category', 'class' => 'form-control')); ?>
                        </div>
                    </div>
