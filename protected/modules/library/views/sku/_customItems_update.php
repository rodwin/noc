            ...
            foreach ($custom_datas as $key => $val) {
                ...
                <?php } else if ($data_type == SkuCustomData::TYPE_NUMBER_ONLY) { ?>
                    ...
                    <div class="form-group">
                        ...
                        <?php echo CHtml::textField($post_name, isset($_POST[$post_name]) ? $_POST[$post_name] : $val['custom_data_value'], array('maxlength' => SkuCustomData::CUSTOM_VALUE_LENGTH, "onkeypress" => "return onlyDotsAndNumbers(this, event, $decimal_place)", 'class' => 'form-control input', 'placeholder' => $placeholder)) ?>
                        <?php echo isset($_POST[$post_name]) ? $form->error($sku_custom_data, $post_name, array("style" => "color: #f56954;")) : ""; ?>	
                    </div>
