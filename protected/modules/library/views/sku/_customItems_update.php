                ...
                if ($data_type == 'Text and Numbers') {
                    ...
                    if ($attr['text_field'] == 1) {
                        ...
                        <div class="form-group">
                            ...
                            <?php echo CHtml::textArea($post_name, isset($_POST[$post_name]) ? $_POST[$post_name] : $val['custom_data_value'], array('maxlength' => isset($attr['max_character_length']) ? $attr['max_character_length'] : "", 'class' => 'form-control input-sm', 'style' => 'resize: none; height: 100px;')); ?>
                        </div>
                    ...
                    <?php } else { ?>
                        ...
                        <div class="form-group">
                            <label><?php echo $label_name; ?></label>                            
                            <?php echo CHtml::textField($post_name, isset($_POST[$post_name]) ? $_POST[$post_name] : $val['custom_data_value'], array('maxlength' => isset($attr['max_character_length']) ? $attr['max_character_length'] : "", 'class' => 'form-control input-sm')); ?>
                        </div>
