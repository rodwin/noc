...
class PoiCategoryController extends Controller
{
    ...
    */
    public function actionView($id)
    {
        ...
        $this->pageTitle = 'View PoiCategory '.$model->poi_category_id;

        $this->menu=array(
                array('label'=>'Create PoiCategory', 'url'=>array('create')),
                array('label'=>'Update PoiCategory', 'url'=>array('update', 'id'=>$model->poi_category_id)),
                array('label'=>'Delete PoiCategory', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->poi_category_id),'confirm'=>'Are you sure you want to delete this item?')),
                array('label'=>'Manage PoiCategory', 'url'=>array('admin')),
                '',
    ...
    */
    public function actionCreate()
    {
        ...
        $this->pageTitle = 'Create PoiCategory';
    ...
    */
    public function actionUpdate($id)
    {
        ...
        $this->menu=array(
                array('label'=>'Create PoiCategory', 'url'=>array('create')),
                array('label'=>'View PoiCategory', 'url'=>array('view', 'id'=>$model->poi_category_id)),
                array('label'=>'Manage PoiCategory', 'url'=>array('admin')),
                '',
                array('label'=>'Help', 'url' => '#'),
        );

        $this->pageTitle = 'Update PoiCategory '.$model->poi_category_id;
    ...
    */
    public function actionAdmin()
    {
        ...
        $this->pageTitle = 'Manage PoiCategory';
