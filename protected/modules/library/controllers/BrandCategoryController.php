...
class BrandCategoryController extends Controller {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow',
                'actions' => array('admin'),
                'expression' => "Yii::app()->user->checkAccess('Manage Brand Category', array('company_id' => Yii::app()->user->company_id))",
            ),
            array('allow',
                'actions' => array('create'),
                'expression' => "Yii::app()->user->checkAccess('Add Brand Category', array('company_id' => Yii::app()->user->company_id))",
            ),
            array('allow',
                'actions' => array('view'),
                'expression' => "Yii::app()->user->checkAccess('View Brand Category', array('company_id' => Yii::app()->user->company_id))",
            ),
            array('allow',
                'actions' => array('edit'),
                'expression' => "Yii::app()->user->checkAccess('Edit Brand Category', array('company_id' => Yii::app()->user->company_id))",
            ),
            array('allow',
                'actions' => array('delete'),
                'expression' => "Yii::app()->user->checkAccess('Delete Brand Category', array('company_id' => Yii::app()->user->company_id))",
            ),
    ...
    public function actionData() {
        ...
        BrandCategory::model()->search_string = $_GET['search']['value'] != "" ? $_GET['search']['value'] : null;

        $dataProvider = BrandCategory::model()->data($_GET['order'][0]['column'], $_GET['order'][0]['dir'], $_GET['length'], $_GET['start'], $_GET['columns']);

        $count = BrandCategory::model()->countByAttributes(array('company_id' => Yii::app()->user->company_id));
    ...
    public function actionCreate() {
        ...
        $this->pageTitle = 'Create BrandCategory';
        ...
        $model = new BrandCategory('create');
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('BrandCategory');
    ...
    public function actionAdmin() {
        ...
        $this->pageTitle = 'Manage BrandCategory';

        $model = new BrandCategory('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['BrandCategory']))
            $model->attributes = $_GET['BrandCategory'];
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'brand-category-form') {
