        ...
        <div class="box box-primary">
            <div class="box-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label for="Employee_default_zone_id" class="col-sm-2 control-label"><?php echo $fields['default_zone_id']; ?></label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="Employee_default_zone_id" placeholder="<?php echo $fields['default_zone_id']; ?>" name="Employee[default_zone_id]">
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="Employee_sales_office_id" class="col-sm-2 control-label"><?php echo $fields['sales_office_id']; ?></label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="Employee_sales_office_id" placeholder="<?php echo $fields['sales_office_id']; ?>" name="Employee[sales_office_id]">
                        </div>
                    </div>
