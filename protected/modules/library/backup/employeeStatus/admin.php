...
<script type="text/javascript">
    $(function() {
        var table = $('#employee-status_table').dataTable({
            ...
            "columns": [
//                {"name": "employee_status_id", "data": "employee_status_id"},
        ...
        $('#btnSearch').click(function() {
            table.fnMultiFilter({
//                "employee_status_id": $("#EmployeeStatus_employee_status_id").val(),
                "employee_status_code": $("#EmployeeStatus_employee_status_code").val(),
                "description": $("#EmployeeStatus_description").val(),
                "available": $("#EmployeeStatus_available").val(),
                "created_date": $("#EmployeeStatus_created_date").val(),
                "created_by": $("#EmployeeStatus_created_by").val(),
                "updated_date": $("#EmployeeStatus_updated_date").val(),
            });
        });
