...
class EmployeeController extends Controller {
    ...
    public function actionData() {
        ...
        foreach ($dataProvider->getData() as $key => $value) {
            ...
            $row['employee_type_code'] = $value->employeeType->employee_type_code;
    ...
    public function actionView($id) {
        ...
        $this->pageTitle = 'View Employee ' . $model->employee_id;
    ...
    public function actionCreate() {
        ...
        $employee_status_list = CHtml::listData(EmployeeStatus::model()->findAll(array('condition' => 'company_id = "' . Yii::app()->user->company_id . '"', 'order' => 'employee_status_code ASC')), 'employee_status_id', 'employee_status_code');
        $employee_type_list = CHtml::listData(EmployeeType::model()->findAll(array('condition' => 'company_id = "' . Yii::app()->user->company_id . '"', 'order' => 'employee_type_code ASC')), 'employee_type_id', 'employee_type_code');
    ...
    public function actionUpdate($id) {
        ...
        $this->pageTitle = 'Update Employee ' . $model->employee_id;
    ...
    public function loadModel($id) {
        ...
        $c = new CDbCriteria;
        $c->select = "t.*, employee_status.employee_status_code as employee_status_code";
        $c->compare('t.company_id', Yii::app()->user->company_id);
        $c->compare('t.employee_id', $id);
        $c->join = "LEFT JOIN employee_status ON employee_status.employee_status_id = t.employee_status";

        $model = Employee::model()->find($c);
        if ($model === null)
