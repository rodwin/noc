...
class Poi extends CActiveRecord
{
	...
	public function rules()
	{
        ...
        public function beforeValidate() {
            if ($this->scenario == 'create') {
                ...
                $this->poi_id = Globals::generateV4UUID();                
        ...
        public function data($col, $order_dir,$limit,$offset,$columns)
	{
                switch($col){
                        ...
                        case 2:
                        $sort_column = 'long_name';
                        break;
                                        
                        case 3:
                        $sort_column = 'primary_code';
                        break;
                                        
                        case 4:
                        $sort_column = 'secondary_code';
                        break;
		...
		$criteria->compare('short_name',$columns[1]['search']['value'],true);
		$criteria->compare('long_name',$columns[2]['search']['value'],true);
		$criteria->compare('primary_code',$columns[3]['search']['value'],true);
		$criteria->compare('secondary_code',$columns[4]['search']['value'],true);
		$criteria->compare('barangay_id',$columns[5]['search']['value']);
		$criteria->compare('municipal_id',$columns[6]['search']['value']);
