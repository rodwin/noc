...
class Salesman extends CActiveRecord
{
	...
	public function rules()
	{
        ...
        public function beforeValidate() {
            if ($this->scenario == 'create') {
                ...
                $this->salesman_id = Globals::generateV4UUID();                
        ...
        public function data($col, $order_dir,$limit,$offset,$columns)
	{
		...
		$criteria->compare('team_leader_id',$columns[1]['search']['value'],true);
		$criteria->compare('salesman_name',$columns[2]['search']['value'],true);
		$criteria->compare('salesman_code',$columns[3]['search']['value'],true);
		$criteria->compare('mobile_number',$columns[4]['search']['value'],true);
		$criteria->compare('device_no',$columns[5]['search']['value'],true);
		$criteria->compare('other_fields_1',$columns[6]['search']['value'],true);
