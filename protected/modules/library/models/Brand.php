...
class Brand extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('brand_id, brand_code, company_id, brand_name', 'required'),
        ...
        public function beforeValidate() {
            if ($this->scenario == 'create') {
                ...
                $this->brand_id = Globals::generateV4UUID();                
        ...
        public function data($col, $order_dir,$limit,$offset,$columns)
	{
                ...
                $criteria=new CDbCriteria;
                $criteria->compare('company_id',Yii::app()->user->company_id);
                		$criteria->compare('brand_id',$columns[0]['search']['value'],true);
		$criteria->compare('brand_category_id',$columns[1]['search']['value'],true);
		$criteria->compare('brand_code',$columns[2]['search']['value'],true);
		$criteria->compare('brand_name',$columns[3]['search']['value'],true);
