    ...
    function redraw(){
      ...
      var att_year =  document.getElementById('att_year');
        $.ajax({
            ...
            'type':'GET',
            'dataType': 'json',
            'data':'agency='+agency.value+'&region='+region.value+'&month='+month.value+'&brand='+brand.value+'&year='+att_year.value,
             beforeSend: function(){
...
$('#Dtd_province').change(function() {
    
    redraw(); 
    
});
$('#Dtd_month').change(function() {
    
    redraw(); 
    
});
$('#Dtd_brand').change(function() {
