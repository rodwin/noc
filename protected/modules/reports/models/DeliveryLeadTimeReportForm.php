...
class DeliveryLeadTimeReportForm extends CFormModel {
   ...
   public function getData($destination, $from_date, $to_date) {
      ...
      switch ($destination) {
         case "SW":
            $sql = "SELECT b.supplier_name, c.sales_office_name, a.po_no, a.pr_no, a.pr_date, a.plan_delivery_date, a.dr_no, a.dr_date, a.transaction_date
            ...
            break;
         case "WS":
            $sql = "SELECT (SELECT sales_office_name FROM sales_office WHERE sales_office_id = b.distributor_id ) AS warehouse, b.sales_office_name, c.po_no, c.pr_no, c.pr_date, a.plan_delivery_date, a.dr_no, a.dr_date, a.transaction_date
            ...
            break;
         case "SO":
            $sql = "SELECT d.sales_office_name, e.short_name, b.po_no, b.pr_no, a.rra_no, a.rra_date, a.dr_no, a.plan_delivery_date, b.plan_arrival_date, a.transaction_date
