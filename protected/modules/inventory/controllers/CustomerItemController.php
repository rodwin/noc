        ...
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('data', 'loadTransactionByDRNo', 'loadInventoryDetails', 'customerItemDetailData', 'uploadAttachment', 'preview', 'download',
                    'print', 'loadPDF', 'getDetailsByCustomerItemID', 'viewPrint', 'loadItemDetails', 'checkInvIfUpdatedActualQtyValid', 'updateCustomerItemDetailReturnDate'),
                'users' => array('@'),
            ),
            array('allow',
                'actions' => array('admin'),
                'expression' => "Yii::app()->user->checkAccess('Manage Outgoing', array('company_id' => Yii::app()->user->company_id))",
                'users' => array('@'),
            ),
            array('allow',
                'actions' => array('create'),
                'expression' => "Yii::app()->user->checkAccess('Add Outgoing', array('company_id' => Yii::app()->user->company_id))",
                'users' => array('@'),
            ),
            array('allow',
                'actions' => array('view'),
                'expression' => "Yii::app()->user->checkAccess('View Outgoing', array('company_id' => Yii::app()->user->company_id))",
                'users' => array('@'),
            ),
            array('allow',
                'actions' => array('update'),
                'expression' => "Yii::app()->user->checkAccess('Edit Outgoing', array('company_id' => Yii::app()->user->company_id))",
                'users' => array('@'),
            ),
            array('allow',
                'actions' => array('delete', 'deleteCustomerItemDetail', 'deleteAttachment'),
                'expression' => "Yii::app()->user->checkAccess('Delete Outgoing', array('company_id' => Yii::app()->user->company_id))",
                'users' => array('@'),
            ),
