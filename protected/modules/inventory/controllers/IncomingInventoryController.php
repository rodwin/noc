   ...
   public function accessRules() {
      return array(
          ...
          array('allow', // allow authenticated user to perform 'create' and 'update' actions
              'actions' => array('create', 'update', 'data', 'loadAllOutgoingTransactionDetailsByDRNo', 'loadInventoryDetails', 'incomingInvDetailData', 'uploadAttachment', 'preview', 'deleteByUrl', 'download', 'deleteIncomingDetail', 'deleteAttachment'),
              'users' => array('@'),
          ),
   ...
   public function actionDelete($id) {
      if (Yii::app()->request->isPostRequest) {
         try {
                ...
                // delete receiving details by incoming_inventory_id
                ...
                $this->deleteAttachmenntByIncomingInvID($id);
...
//         }
   ...
   public function deleteAttachmenntByIncomingInvID($incoming_inv_id, $transaction_type = "incoming") {
...
//                    'delete_type' => 'POST',
   ...
   function actionPreview($id) {
      ...
      $c->compare("transaction_type", "incoming");
      ...
      foreach ($attachment as $key => $value) {
         ...
         $row['links'] = '<a class="btn btn-sm btn-default" title="Delete" href="' . $this->createUrl('/inventory/incominginventory/download', array('id' => $value->attachment_id)) . '">
