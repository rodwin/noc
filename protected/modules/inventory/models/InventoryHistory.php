...
class InventoryHistory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('inventory_id, quantity_change', 'required'),
			array('inventory_id, quantity_change, running_total', 'numerical', 'integerOnly'=>true),
			array('action, created_by, updated_by', 'length', 'max'=>50),
			array('cost_unit', 'length', 'max'=>18),
			array('ave_cost_per_unit', 'length', 'max'=>19),
			array('created_date, updated_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('inventory_history_id, inventory_id, quantity_change, running_total, action, cost_unit, ave_cost_per_unit, created_date, created_by, updated_date, updated_by', 'safe', 'on'=>'search'),
		);
	}
        ...
        public function data($col, $order_dir,$limit,$offset,$columns)
	{
		...
		$criteria->compare('inventory_id',$columns[1]['search']['value']);
		$criteria->compare('quantity_change',$columns[2]['search']['value']);
		$criteria->compare('running_total',$columns[3]['search']['value']);
		$criteria->compare('action',$columns[4]['search']['value'],true);
		$criteria->compare('cost_unit',$columns[5]['search']['value'],true);
		$criteria->compare('ave_cost_per_unit',$columns[6]['search']['value'],true);
