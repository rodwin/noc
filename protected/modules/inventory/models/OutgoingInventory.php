...
class OutgoingInventory extends CActiveRecord {
   ...
   public function rules() {
      ...
      return array(
          ...
          array('outgoing_inventory_id, pr_date, plan_delivery_date, revised_delivery_date, actual_delivery_date, plan_arrival_date, transaction_date, created_date, updated_date', 'safe'),
