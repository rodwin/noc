   ...
   <div class="span7">
      ...
      <span class="btn btn-success fileinput-button btn-sm btn-flat" style="display: none;">
         ...
         if ($this->hasModel()) :
            ...
            echo CHtml::activeFileField($this->model, $this->attribute, array("id" => "return_receipt_file_uploads", "multiple" => true)) . "\n";
         else :
      ...
      <button type="submit" class="btn btn-primary btn-sm btn-flat start" id="return_receipt_uploading_attachments" style="display: none;">
...
<div class="row-fluid">
   <table class="table table-striped" id="return_receipt_attached_table">
