...
<?php $fields = Supplier::model()->attributeLabels(); ?>	                
        ...
        <div class="form-group">
            <label for="Supplier_barangay" class="col-sm-2 control-label"><?php echo $fields['barangay'];?></label>
            <div class="col-sm-3">
                <input type="text" class="form-control" id="Supplier_barangay" placeholder="<?php echo $fields['barangay'];?>" name="Supplier[barangay]">
            </div>
        </div>
	                
        <div class="form-group">
            <label for="Supplier_municipal" class="col-sm-2 control-label"><?php echo $fields['municipal'];?></label>
            <div class="col-sm-3">
                <input type="text" class="form-control" id="Supplier_municipal" placeholder="<?php echo $fields['municipal'];?>" name="Supplier[municipal]">
            </div>
        </div>
	                
        <div class="form-group">
            <label for="Supplier_province" class="col-sm-2 control-label"><?php echo $fields['province'];?></label>
            <div class="col-sm-3">
                <input type="text" class="form-control" id="Supplier_province" placeholder="<?php echo $fields['province'];?>" name="Supplier[province]">
            </div>
        </div>
	                
        <div class="form-group">
            <label for="Supplier_region" class="col-sm-2 control-label"><?php echo $fields['region'];?></label>
            <div class="col-sm-3">
                <input type="text" class="form-control" id="Supplier_region" placeholder="<?php echo $fields['region'];?>" name="Supplier[region]">
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="Supplier_update_date" class="col-sm-2 control-label"><?php echo $fields['update_date'];?></label>
            <div class="col-sm-3">
                <input type="text" class="form-control" id="Supplier_update_date" placeholder="<?php echo $fields['update_date'];?>" name="Supplier[update_date]">
            </div>
        </div>
	                
        <div class="form-group">
            <label for="Supplier_update_by" class="col-sm-2 control-label"><?php echo $fields['update_by'];?></label>
            <div class="col-sm-3">
                <input type="text" class="form-control" id="Supplier_update_by" placeholder="<?php echo $fields['update_by'];?>" name="Supplier[update_by]">
            </div>
        </div>
	<div class="form-group">
