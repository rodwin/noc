...
$(function() {
    var table = $('#supplier_table').dataTable({
        ...
        "columns": [
            { "name": "supplier_id","data": "supplier_id"},{ "name": "supplier_code","data": "supplier_code"},{ "name": "supplier_name","data": "supplier_name"},{ "name": "contact_person1","data": "contact_person1"},{ "name": "contact_person2","data": "contact_person2"},{ "name": "telephone","data": "telephone"},{ "name": "cellphone","data": "cellphone"},            { "name": "links","data": "links", 'sortable': false}
               ]
        });
